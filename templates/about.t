...
{% block menu %}
  <div class="level-right ">
    ...
    <p class="level-item"><a href="/om" title="Om tjenesten" alt="Om tjenesten" class="button is-primary"><strong>Om tjenesten</strong></a></p>
  </div>
{% endblock %}
