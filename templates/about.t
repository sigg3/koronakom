...
<section class="section">
    ...
    <div class="container has-text-centered">
        <a href="https://github.com/sigg3/koronakom" title="Koronakom på Github" class="has-text-white pt-3"><button class="button is-success is-rounded">github: <strong>Koronakom</strong></button></a>
    </div>
